"""
VALIDATION_C4_accuracy_brownie_pack_SPEC.py
===========================================
...
Run: `python track_C_integration_SPEC/VALIDATION_C4_accuracy_brownie_pack_SPEC.py`
"""
...
from track_B_projectile_SPEC.B1_point_mass_force_model_gravity_drag_wind_SPEC import (
    acceleration_total_SPEC,
)
from track_B_projectile_SPEC.B3_dartboard_scoring_radial_angular_SPEC import (
...
def run_accuracy_brownie_pack_SPEC() -> dict:
    ...
    out_md = _ARTIFACTS / "C4_accuracy_brownie_pack_SPEC.md"
    out_md.write_text("\n".join(md_lines) + "\n", encoding="utf-8")
