"""
VALIDATION_C7_spin_contact_confidence_SPEC.py
=============================================
Phase 3 of pre-RL confidence plan: spin + contact manipulation confidence.

Run:
  python track_C_integration_SPEC/VALIDATION_C7_spin_contact_confidence_SPEC.py
"""
...
from spin_relevance_SPEC.spin_ablation_SPEC import SpinStudyConfig_SPEC, run_spin_relevance_study_SPEC
...
def run_spin_contact_confidence_SPEC() -> dict:
    ...
    out_json = _ARTIFACTS / "C7_spin_contact_confidence_SPEC.json"
    ...
    out_md = _ARTIFACTS / "C7_spin_contact_confidence_SPEC.md"
    out_md.write_text("\n".join(lines) + "\n", encoding="utf-8")
