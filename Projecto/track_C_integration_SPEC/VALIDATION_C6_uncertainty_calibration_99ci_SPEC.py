"""
VALIDATION_C6_uncertainty_calibration_99ci_SPEC.py
==================================================
Phase 2 of pre-RL confidence plan: uncertainty calibration with 99% CIs.

Run:
  python track_C_integration_SPEC/VALIDATION_C6_uncertainty_calibration_99ci_SPEC.py
"""
...
from spin_relevance_SPEC.spin_ablation_SPEC import paired_spin_effect_metrics_SPEC
from track_A_arm_SPEC.A3_cubic_spline_and_pd_controller_SPEC import simulate_throw_mujoco_SPEC
from track_C_integration_SPEC.C1_pipeline_arm_release_to_projectile_score_SPEC import score_from_release_state_SPEC
...
def run_uncertainty_calibration_99ci_SPEC() -> dict:
    ...
    out_json = _ARTIFACTS / "C6_uncertainty_calibration_99ci_SPEC.json"
    ...
    out_md = _ARTIFACTS / "C6_uncertainty_calibration_99ci_SPEC.md"
    out_md.write_text("\n".join(lines) + "\n", encoding="utf-8")
