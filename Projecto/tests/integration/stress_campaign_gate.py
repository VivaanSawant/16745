"""
VALIDATION_integration_stress_campaign_gate_SPEC.py
==========================================
Phase 4 of pre-RL confidence plan: cross-seed stress campaign and readiness gate.

Run:
  python integration_phase_SPEC/VALIDATION_integration_stress_campaign_gate_SPEC.py
"""
...
def run_stress_campaign_gate_SPEC() -> dict:
        ...
        for wind in winds:
            for rt_offset in release_offsets:
                ...
                for seed in seeds:
                    ...
                    local_action[12] = float(local_action[12] + rt_offset)
    ...
    out_json = _ARTIFACTS / "integration_stress_campaign_gate_SPEC.json"
    out_json.write_text(json.dumps(status, indent=2), encoding="utf-8")

    lines = [
        "# Integration stress campaign gate",
        "",
    ...
    out_md = _ARTIFACTS / "integration_stress_campaign_gate_SPEC.md"
    out_md.write_text("\n".join(lines) + "\n", encoding="utf-8")
