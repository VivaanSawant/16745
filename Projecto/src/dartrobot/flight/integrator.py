"""
flight_ode_integrator_event_board_plane_SPEC.py
============================================
...
from dartrobot.constants import BULLSEYE_CENTER_Z_M, OCHE_TO_BOARD_X_M
from dartrobot.flight.forces import state_derivative_SPEC
