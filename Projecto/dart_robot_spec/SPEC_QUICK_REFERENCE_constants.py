...
plus Track A geometry (pages 1–2) where noted.
...
N_SPLINE_KNOTS_PER_JOINT = 3  # PDF: 3 knots per joint → 9 policy parameters total
N_POLICY_PARAMETERS = 9  # 3 joints × 3 knots
